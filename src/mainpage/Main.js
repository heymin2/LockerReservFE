      ...
      <div className="app-center">
        <div className='box'>
          <Link to="/">
            ...
            <main>
              <img className="locker1" src={"빨간사물함.png"} onClick={() => alert('로그인하세요')} />
              <img className="locker1" src={"파란사물함.png"} onClick={() => alert('로그인하세요')} />
              <img className="locker1" src={"회색사물함.png"} onClick={() => alert('로그인하세요')} />
              <img className="locker1" src={"회색사물함.png"} onClick={() => alert('로그인하세요')} />
              <img className="locker1" src={"빨간사물함.png"} onClick={() => alert('로그인하세요')} />
              <img className="locker1" src={"파란사물함.png"} onClick={() => alert('로그인하세요')} />
              <img className="locker1" src={"회색사물함.png"} onClick={() => alert('로그인하세요')} />
